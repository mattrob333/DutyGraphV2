...
The Discovery business-type catalog now shows all 52 operating patterns as cards with descriptions, familiar organization examples, stage previews and an explicit add action. Search by type (including catalog shorthand such as SaaS), family or example company. Examples are recognition aids only, kept out of AI prompts and company evidence. See [initial research](docs/initial-research.md).
