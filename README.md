...
Latest local verification: **317 tests pass**, production build and 105-route contracts pass, and dependency audit reports zero vulnerabilities. Synthetic browser checks cover map/flow/task navigation, responsive views, live brief through approved report download, weekly measurement/commitment updates, and Strategy input/source navigation. Publication and acceptance are recorded in [verification](docs/verification/2026-09-08-marquee-client-brief.md). No migration or additional provider is required for this release. Real client delivery and the full hosted audit walkthrough remain separate acceptance work.
