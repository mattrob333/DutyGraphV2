...
Release `0c9e8ce` passed 263 local tests and CI `34228366691`, and deployed READY. The hosted site serves the new intake and automatic-mapping controls; the inbox denies signed-out access. Integrated browser verification used synthetic providers and fictional data. Real-provider output quality and email delivery remain separate checks.
