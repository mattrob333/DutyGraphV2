...
1. [Product vision](Product-Vision.md): customer, problem, commercial direction.
2. [User journeys](User-Journeys.md): what the experience should accomplish.
3. [Current state](Current-State.md): implemented, simulated, and unfinished.
4. [Developer onboarding](Developer-Onboarding.md): local setup and first contribution.
5. [Architecture and data](Architecture-and-Data.md): boundaries that changes must preserve.
6. [Discovery and strategy](Discovery-and-Strategy.md): evidence, prompts, and frameworks.
7. [Governance and integrations](Governance-and-Integrations.md): delegation and external systems.
8. [Operations and deployment](Operations-and-Deployment.md): safe release and recovery.
9. [Marketing and publishing](Marketing-and-Publishing.md): website, articles, directory, leads.
