...
export const frameworkSpecs: Record<string, FrameworkSpec> = {
  ...
  industrymap: {
    ...
    inputs: [
      ...
      variable(
        "chain",
        "Value chain and routes to market",
        "Inputs, supplier categories, intermediaries, distribution, buyers, end users, and organizations which support or regulate the market.",
    ...
    sections: [
      section(
        "suppliers",
        "Inputs & suppliers",
        "Name evidenced upstream firms or supplier categories and what moves from them.",
      ),
      section(
        "company",
        "The company",
        "State the company's position in the chain and the value it adds.",
      ),
      section(
        "channels",
        "Channels & partners",
        "Identify distributors, marketplaces and intermediaries. Distinguish ownership from partnership.",
      ),
      section(
        "buyers",
        "Buyers & users",
        "Name the buying segments and end users; identify concentration only if known.",
      ),
      section(
        "rivals",
        "Direct rivals",
        "List genuinely comparable firms, their offers and market overlap. Cite the public page and date.",
      ),
      section(
        "substitutes",
        "Substitutes & adjacent players",
        "Show alternate ways to achieve the job, including internal provision or doing nothing.",
      ),
    ],
    instructions: [
      "Read the first four sections as a left-to-right value chain. Describe what passes across each relationship in the item detail; do not infer a contractual connection from shared market presence.",
      "Use a precise market boundary. A famous company is not automatically a relevant competitor. Explain why each rival or substitute belongs here.",
      "Treat the map as a dated snapshot. Mark missing channel, customer or supplier data. Do not turn public company counts into invented market shares.",
    ],
  },
  fiveforces: {
