...
import { z } from "zod";
import { pilotSummary } from "./pilot-summary.ts";
...
try {
  if (process.argv[2] === "summary") {
    console.log(JSON.stringify(await pilotSummary(db), null, 2));
  } else {
    if (process.argv[2] === "update") {
      ...
      throw new Error("Use summary, list or update <private-json-file>.");
