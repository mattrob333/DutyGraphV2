...
const page = (title: string, body: string, index = true) =>
  `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escapeHtml(title)} | Duty Graph 0.2</title><style>${style}</style></head><body><header><div class="eyebrow">DUTY GRAPH · ADVISOR ENABLEMENT</div><p>Release 0.2 · Local advisor pilot · September 2026</p></header><main>${index ? '<nav><a href="index.html">← Handbook contents</a></nav>' : ""}${body}<footer>Duty Graph 0.2. Authored guidance for the implemented application. Northstar examples are synthetic. Work review, authority, deployment and observed execution remain distinct.</footer></main></body></html>`;
